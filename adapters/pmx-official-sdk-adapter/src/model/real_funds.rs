...
pub struct ReviewedRealFundsCanaryReleaseDecision {
    ...
    pub github_evidence_details: serde_json::Value,
    ...
    pub review_signature_evidence_ref: String,
    pub review_signature_evidence_sha256: String,
    pub reviewer_check_evidence_refs: serde_json::Value,
    pub reviewer_check_evidence_sha256s: serde_json::Value,
