...
Current boundary: until these logs are produced and reviewed for the exact artifact under review, v0.26.1 remains a controlled real-funds canary source-candidate, not a validated release. Live submit and live cancel remain disabled.
