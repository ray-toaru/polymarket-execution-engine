...
> Status: current v0.27.3 controlled real-funds canary source-candidate documentation.

`../AGENTS.md` contains execution-engine-specific agent rules. Current documents in this directory describe the v0.27.3 controlled real-funds canary source-candidate state. Historical continuation, review, and gate-confirmation notes live under `docs/archive/` and are excluded from normal release packaging.
